...
ResetEntry
	...
	|
	b	ResetHandler   ;0x0000 0000
    ]
	b	HandlerUndef	;handler for Undefined mode 0x0000 0004
	b	HandlerSWI	;handler for SWI interrupt      0x0000 0008
	b	HandlerPabort	;handler for PAbort         0x0000 000c
	b	HandlerDabort	;handler for DAbort         0x0000 0010
	b	.		;reserved                           0x0000 0014
	b	HandlerIRQ	;handler for IRQ interrupt      0x0000 0018
	b	HandlerFIQ	;handler for FIQ interrupt      0x0000 001c
...
;===========================================================
  	; Setup IRQ handler
	ldr	r0,=HandleIRQ       ;This routine is needed 宏
